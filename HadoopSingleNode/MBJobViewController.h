...
@property (weak) IBOutlet NSTextField *argumentsTextfield;
@property (weak) IBOutlet MBDragJarView *dragImageView;
@property (weak) IBOutlet NSButton *loadNewJobView;
@property (weak) IBOutlet NSButton *logButton;

@property (weak) IBOutlet NSButton *runButton;
@property (weak) IBOutlet NSTextField *dragTextField;
